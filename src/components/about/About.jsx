                ...
                <div class="card__inner">
                  ...
                  <div class="card__face card__face--back">
                    <div class="card__content">
                      <div class="card__body">
                        <ul>
                          <li>Programming Languages: Java, C, C++, Python, x86 ASM, R, Swift</li>
                          <li>Front-End Development: HTML, CSS, Javascript, React, Angular, Bootstrap, Streamlit</li>
                          <li>Back-End Development: PHP, MYSQL, Flask</li>
                        </ul>
                      </div>
                    </div>
                  </div>
